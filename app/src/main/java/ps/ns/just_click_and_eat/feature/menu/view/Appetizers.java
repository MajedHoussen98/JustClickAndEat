...
import ps.ns.just_click_and_eat.databinding.FragmentAppetizersBinding;
...
public class Appetizers extends Fragment implements MenuAdapter.ListItemClickListener {

    private MenuAdapter adapter;
    private ArrayList<MenuModel> list;
    private View view;
    private FragmentAppetizersBinding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentAppetizersBinding.inflate(getLayoutInflater());
    ...
    private void getAppetizerData() {
        ...
        binding.rvAppetizers.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter= new MenuAdapter(getContext(), list, this);
        binding.rvAppetizers.setAdapter(adapter);
    }
